...
const Login = () => {
   ...
   {message && <div className="alert alert-warning m-0 " role="alert">{message}</div>}
        ...
        <div className="login-container">
            ...
            <div className="google-auth d-flex align-items-center">
                <button className="g-btn"  onClick={googleAuthHandel}>
                    <img className='g-img' src={Gimg} alt="" />
                    <span className='g-btn-text'> Sign In Google</span>
                </button>
                {showResendVerification && (
                    <button className='varify-btn mx-2' onClick={handleResendVerification}>Verifiy Email</button>
                )}
            </div>
        </div>
        </div>
